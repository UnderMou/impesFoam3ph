        ...
        {      
            ...
            {   
                ...
                {   
                    ...
                    // phiPc.boundaryFieldRef()[patchi] = 0.0;
            ...
            // Mechanistic model - Ashoori

            F = -fvc::div(phia); // + qa
            AcumCoeff = eps*(scalar(1.0) - Sb + VSMALL); // eps*Sa
            rgrc = correct_rgrc(Sb,nD,Kc,nMAX,Sw_ast,A);
            ...
            (
                ...
                ==
                (eps*(scalar(1.0) - Sb + VSMALL)/nMAX)*rgrc + fvc::Sp(-F,nD) // + qf
            );
