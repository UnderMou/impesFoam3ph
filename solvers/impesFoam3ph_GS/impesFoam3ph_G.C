...
int main(int argc, char *argv[])
{
    ...
    while (simple.loop(runTime))
    {
        ...
        {   
            ...
            Lacf = Fcf*Laf - Faf*Lcf;
            Labf = Fbf*Laf - Faf*Lbf;
            Lbcf = Fcf*Lbf - Fbf*Lcf;
            Lbaf = Faf*Lbf - Fbf*Laf;
            ...
            // phia = Faf*phiP + ((Lacf + Labf)/Lf)*phiG;
            // phib = Fbf*phiP + ((Lbcf + Lbaf)/Lf)*phiG;
            phia = Faf*phiP + (Laf/Lf)*phiG;
