...
int main(int argc, char *argv[])
{
    ...
    while (simple.loop(runTime))
    {
        ...
        {      
            ...
            kra = correct_kra(Sb,Sa_minValue,Sb_minValue,kra_maxValue,a_expValue,fmmobValue,SFValue,sfbetValue,U,fmcapValue,epcapValue,mu_b,sigma_baValue,fmsurfValue,epsurfValue,Cs);
            ...
            F = -fvc::div(phib); // + qb
            AcumCoeff = eps*Sb + (scalar(1.0) - eps)*rho_sw*correct_dCsEqdCs(KdValue);
