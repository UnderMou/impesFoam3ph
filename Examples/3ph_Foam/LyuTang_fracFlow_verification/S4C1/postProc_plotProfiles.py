...
if __name__ == '__main__':
    ...
    data_Lyu_Sg = pd.read_csv('reference_results/Sg_analytical_LyuC4.csv')
    data_Lyu_So = pd.read_csv('reference_results/So_analytical_LyuC4.csv')
