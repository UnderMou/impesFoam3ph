...
if __name__ == '__main__':
    ...
    tD = 0.44
    files_dir = os.getcwd() + '/experimental_results/'
    ...
    if tD == 0.44:  t_find = 1000
    if tD == 1.00:  t_find = 2350
    if tD == 10.40: t_find = 149950
    ...
    # print(sample_dir)
    data_dict = parse_openfoam_case(sample_dir, variables=['Sa','Sb','p'])
    ...
    if tD != 10.4:
        ...
        axes[2].plot(x_SgDARTS,Sg_DARTS,'-r', linewidth = 2,label='DARTS - (Lyu, X., 2021)')
    ...
    axes[2].plot(x[:-1],Sa[:-1],c='b', linewidth = 2, label='ImpesFOAM')
