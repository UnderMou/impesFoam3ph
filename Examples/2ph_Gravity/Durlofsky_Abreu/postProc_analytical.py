...
if __name__ == '__main__':
    ...
    # Plot profiles
    colors = ['b', 'r']
    axes[0].plot(x, Sw_t025_grav, c=colors[0], label=r'IMPES - OpenFOAM - $t_D = 0.25$')
    ...
    axes[0].plot(x, Sw_t050_grav, c=colors[1], label=r'IMPES - OpenFOAM - $t_D = 0.5$')
    ...
    # Plot profiles
    colors = ['b', 'r']
    axes[1].plot(x, Sw_t025_nograv, c=colors[0], label=r'ImpesFOAM - $t_D = 0.25$')
    ...
    axes[1].plot(x, Sw_t050_nograv, c=colors[1], label=r'ImpesFOAM - $t_D = 0.5$')
