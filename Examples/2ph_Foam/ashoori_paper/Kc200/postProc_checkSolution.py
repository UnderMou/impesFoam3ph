...
if __name__ == '__main__':
    ...
    data_sw = pd.read_csv('analytical_results/Sw_Kc200.csv')
    data_nd = pd.read_csv('analytical_results/nD_Kc200.csv')
    ...
    # Time and domain
    dt = 0.25
    time_dirs = np.arange(dt,150+dt,dt)
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig('Ashoori_Kc200.pdf', dpi=300)
    plt.show()