...
# TODO: Colocar como input o path para o example_dir dentro do sys.path para poder rodar daqui e ter acesso aos input files de cada example

# DATA SPE10/FOSSIL
spe10 = pd.read_csv('inputs/spe10_layer_36.pbt', header=None)
spe10 = spe10.iloc[:,0].to_numpy()
perm_base = 1e-12

# DATA OPENFOAM
openf = pd.read_csv('inputs/mesh_info_toPlot.csv', header=None)
