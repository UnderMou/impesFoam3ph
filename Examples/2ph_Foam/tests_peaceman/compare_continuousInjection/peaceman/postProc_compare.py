...
if __name__ == "__main__":
    ...
    ax[0].axvline(gas_bkt_BHP, color='gray', ls='--', lw=1.5, label = "gas breakthrough (with BHP limit)")
    ax[2].axvline(gas_bkt_noBHP, color='gray', ls='--', lw=1.5, label = "gas breakthrough (no BHP limit)")
    ax[3].axvline(gas_bkt_BHP, color='k', ls='--', lw=1.5, label = "gas breakthrough (with BHP limit)")
    ax[3].axvline(gas_bkt_noBHP, color='gray', ls='--', lw=1.5, label = "gas breakthrough (no BHP limit)")
