...
if __name__ == '__main__':
    ...
    data_sw = pd.read_csv('analytical_results/Sw_analytic_02.csv',header=None)
    data_cs = pd.read_csv('analytical_results/Cs_analytic_02.csv',header=None)

    time_dirs = np.linspace(0,0.017,int(0.017/0.001)+1).tolist()
    ...
    plt.tight_layout()
    plt.savefig('surfactant_01.pdf', dpi=300)
    plt.show()