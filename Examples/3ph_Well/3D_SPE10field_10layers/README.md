# SPE10 3D domain – 10 layers around Layer n. 36 Full Heterogeneous Field Co-Injection

This case simulates a 3D domain heterogeneous permeability field of 10 layers around **Layer n. 36** from the Tenth SPE Comparative Solution Project in a three-phase (water–oil–gas) co-injection scenario in porous media.
...
This case considers a three-phase (water–oil–gas) flow in a porous medium characterized by a **highly heterogeneous permeability field**, corresponding to Layer 36 of the SPE10 benchmark.
