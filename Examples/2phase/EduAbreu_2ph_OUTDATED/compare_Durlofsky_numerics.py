...
if __name__ == '__main__':
    ...
    # Reading FOSSIL data
    FOSSIL_Grav_t025 = pd.read_csv('FOSSIL_grav_t025.csv')
    FOSSIL_x = FOSSIL_Grav_t025['Points:0']
    FOSSIL_Grav_t025 = FOSSIL_Grav_t025['Gas_Saturation']
    FOSSIL_Grav_t050 = pd.read_csv('FOSSIL_grav_t050.csv')
    FOSSIL_Grav_t050 = FOSSIL_Grav_t050['Gas_Saturation']
    FOSSIL_noGrav_t025 = pd.read_csv('FOSSIL_nograv_t025.csv')
    FOSSIL_noGrav_t025 = FOSSIL_noGrav_t025['Gas_Saturation']
    FOSSIL_noGrav_t050 = pd.read_csv('FOSSIL_nograv_t050.csv')
    FOSSIL_noGrav_t050 = FOSSIL_noGrav_t050['Gas_Saturation']
    ...
    Sws_grav_t050 = []
    for met in methods:
        Sws_grav_t025.append(np.loadtxt('numerics/' + met + '/' + met + '_grav_t025.csv'))
        Sws_grav_t050.append(np.loadtxt('numerics/' + met + '/' + met + '_grav_t050.csv'))
        
    # Plot FOSSIL
    axes[0].plot(FOSSIL_x, FOSSIL_Grav_t025, c='navy', linewidth=1.5, linestyle='--', label=r'FOSSIL')
    axes[0].plot(FOSSIL_x, FOSSIL_Grav_t050, c='navy', linewidth=1.5, linestyle='--')
    ...
    for i in range(len(methods)):
        axes[0].plot(x, Sws_grav_t025[i], c=colors[i], linewidth=1.5, label=f'{methods[i]}')
    ...
    for i in range(len(methods)):
        axes[0].plot(x, Sws_grav_t050[i], c=colors[i], linewidth=1.5)
    ...
    Sws_nograv_t050 = []
    for met in methods:
        Sws_nograv_t025.append(np.loadtxt('numerics/' + met + '/' + met + '_nograv_t025.csv'))
        Sws_nograv_t050.append(np.loadtxt('numerics/' + met + '/' + met + '_nograv_t050.csv'))

    # Plot FOSSIL
    axes[1].plot(FOSSIL_x, FOSSIL_noGrav_t025, c='navy', linewidth=1.5, linestyle='--', label=r'FOSSIL')
    axes[1].plot(FOSSIL_x, FOSSIL_noGrav_t050, c='navy', linewidth=1.5, linestyle='--')
    ...
    for i in range(len(methods)):
        axes[1].plot(x, Sws_nograv_t025[i], c=colors[i], linewidth=1.5, label=f'{methods[i]}')
    ...
    for i in range(len(methods)):
        axes[1].plot(x, Sws_nograv_t050[i], c=colors[i], linewidth=1.5)
