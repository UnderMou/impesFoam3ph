...
legend1 = ax[0].legend(handles=fluid_legend, title="Fluid type", loc="upper left")
ax[0].add_artist(legend1)

# Legend for foam
foam_legend = [
    Line2D([0], [0], color='r', lw=2, linestyle='--', label='Without foam'),
    Line2D([0], [0], color='r', lw=2, linestyle='-',  label='With foam'),
]
ax[0].legend(handles=foam_legend, title="Condition", loc="upper center")
