...
data_Lyu_Sg = pd.read_csv('Sg_analytical_LyuC1.csv')
data_Lyu_So = pd.read_csv('So_analytical_LyuC1.csv')

# Plotting the results
fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(10, 5))

ax1.plot(xD_Fo, Sg_Fo, linestyle='--', color='b', label='FOSSIL')
ax1.plot(xD_OF, Sg_OF, linestyle='--', color='k', label='IMPES - OpenFOAM')
...
ax2.plot(xD_OF, So_OF, linestyle='--', color='k', label='IMPES - OpenFOAM')
