...
if __name__ == '__main__':
    ...
    # Reading FOSSIL data - with gravity
    FOSSIL_data = pd.read_csv('FOSSIL_Gd_0.085.csv')
    Sg_Grav_FOSSIL = FOSSIL_data['Gas_Saturation']
    So_Grav_FOSSIL = FOSSIL_data['Oil_Saturation']
    Sw_Grav_FOSSIL = FOSSIL_data['Water_Saturation']
    x_Grav_FOSSIL = FOSSIL_data['Points:0']

    # Reading FOSSIL data - without gravity
    FOSSIL_data = pd.read_csv('FOSSIL_Gd_0.csv')
    ...
    x_noGrav_FOSSIL = FOSSIL_data['Points:0']
    ...
    axes[0].plot(x_Grav_FOSSIL, So_Grav_FOSSIL, c=colors[2], linewidth=1, label=r'FOSSIL - gravity')
    axes[0].plot(x_noGrav_FOSSIL, So_noGrav_FOSSIL, c=colors[2], linestyle='--', linewidth=1, label=r'FOSSIL - no gravity')
    axes[0].grid()
    ...
    axes[1].plot(x_Grav_FOSSIL, Sw_Grav_FOSSIL, c=colors[2], linewidth=1, label=r'FOSSIL - gravity')
    axes[1].plot(x_noGrav_FOSSIL, Sw_noGrav_FOSSIL, c=colors[2], linestyle='--', linewidth=1, label=r'FOSSIL - no gravity')
    axes[1].grid()
    ...
    axes[2].plot(x_Grav_FOSSIL, Sg_Grav_FOSSIL, c=colors[2], linewidth=1, label=r'FOSSIL - gravity')
    axes[2].plot(x_noGrav_FOSSIL, Sg_noGrav_FOSSIL, c=colors[2], linestyle='--', linewidth=1, label=r'FOSSIL - no gravity')
    axes[2].grid()
