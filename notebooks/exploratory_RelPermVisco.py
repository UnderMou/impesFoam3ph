...
if __name__ == '__main__':
    ...
    column_names = ['mu_g', 'mu_w', 'mu_o', 'ng', 'nw', 'no', 'krg0', 'krw0', 'kro0','OilBank_length', 'OilBank_height', 'OilBank_area']
    ...
    for i in range(len(QoIs)):
        ...
        plt.close()
        g = sns.PairGrid(X_ED_new, x_vars=np.concatenate((['mu_g', 'mu_w', 'mu_o', 'ng', 'nw', 'no', 'krg0', 'krw0', 'kro0'],[corr_toPlot])), y_vars=[corr_toPlot], height=3.0, aspect=1.0)
